...
SUPABASE_URL = os.environ.get("SQLALCHEMY_DATABASE_URI", "postgresql://postgres.uxneoopglnauvrykbzuc:nijgep-gygjYk-xavca9@aws-0-eu-central-1.pooler.supabase.com:6543/postgres")
