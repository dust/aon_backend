...
SUPABASE_URL = os.environ.get("SUPABASE_URL", "postgresql://postgres.exsligkuvicrfiirsmdg:H2FrhBZv1PRE9sf2@aws-0-eu-central-1.pooler.supabase.com:6543/postgres")
